...
We intends to apply kNN, Decision-Tree, Random-Forest and SVM with Radial Kernal and fine tune their parameters using cross-validation. We will compare the validation accuracy of each fine-tuned model and select the best one for the prediction of liver disease. 
...
vec <- seq(1,nrow(exgrd)) #Index vector to sweep through exgrd vector using sapply
...
Since, the prediction of liver disease should be supportive for medical decisions, 
